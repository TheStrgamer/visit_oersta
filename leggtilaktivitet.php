...
if(isset($_POST["knapp"]) || isset($_GET['submit'])) {
        ...
        $sql = sprintf("INSERT INTO attraksjon(bilde, tittel, info, telefonnummer) VALUES( '%s', '%s', '%s', '%s')",
                ...
                <div id="aktivitetside">
                    ...
                    <form method="POST">
                           ...
                           <button name="preview" type="preview"  style="border:none;background-color:#66aa66; box-shadow: -2px 2px 15px #355535; color:white; width:100px; height:35px" >Preview</button>
                            ...
                            <input type="text" id="leggtilbilde" name="leggtilbilde"><br>
                            ...
                            <?php }else{ ?>
                            <img style="height:425px; box-shadow: -2px 2px 15px #355535; width:90%"  src="bilder/missing.png">
                           <?php } ?>
                    </div>
                    <div style="width:50%">
                    
                            <input type="text" placeholder="Tittel" id="tittel"  name="tittel" style="width:300px; margin-left:75px">
                            
                            <br><br>
                            <h2>Informasjon:</h2>
                            <br>
                            <textarea type="text" id="informasjon" name="informasjon" style="box-shadow: -2px 2px 15px #355535;"></textarea>
                            <p><?php echo $error ?></p>
